...
public class SecretKeyAuthenticatorService
{
    ...
    public SecretKeyAuthenticatorService(TeraMetrics metrics, IDbContextFactory<TeraDbContext> dbContextFactory,
    ...
    private async Task<SecretKeyAuthReply> GetAuthReply(string ip, TeraDbContext context, Auth? authReply)
    {
