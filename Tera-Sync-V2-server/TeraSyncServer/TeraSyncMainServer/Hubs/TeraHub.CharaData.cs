...
public partial class TeraHub
{
    ...
    public async Task<CharaDataFullDto?> CharaDataCreate()
    {
        ...
        _logger.LogCallInfo(TeraHubLogger.Args("SUCCESS", charaDataId));
    ...
    public async Task<bool> CharaDataDelete(string id)
    {
        ...
        try
        {
            _logger.LogCallInfo(TeraHubLogger.Args("SUCCESS", id));
        ...
        {
            _logger.LogCallWarning(TeraHubLogger.Args("FAILURE", id, ex.Message));
            return false;
        }
    }
    ...
    public async Task<List<CharaDataFullDto>> CharaDataGetOwn()
    {
        ...
        _logger.LogCallInfo(TeraHubLogger.Args("SUCCESS"));
    ...
    {
        _logger.LogCallInfo(TeraHubLogger.Args(id));
    ...
    public async Task<List<CharaDataMetaInfoDto>> CharaDataGetShared()
    {
        ...
        _logger.LogCallInfo(TeraHubLogger.Args("SUCCESS", sharedCharaData.Count));
    ...
    public async Task<CharaDataFullDto?> CharaDataUpdate(CharaDataUpdateDto updateDto)
    {
        ...
        if (anyChanges)
        {
            ...
            await DbContext.SaveChangesAsync().ConfigureAwait(false);
            _logger.LogCallInfo(TeraHubLogger.Args("SUCCESS", anyChanges));
        }
    ...
    private async Task<CharaData> GetCharaDataById(string id, string methodName)
    {
        ...
        if (splitid.Length != 2)
        {
            _logger.LogCallWarning(TeraHubLogger.Args("INVALID", id));
        ...
        if (charaData == null)
        {
            _logger.LogCallWarning(TeraHubLogger.Args("NOT FOUND", id));
        ...
        {
            _logger.LogCallWarning(TeraHubLogger.Args("UNAUTHORIZED", id));
