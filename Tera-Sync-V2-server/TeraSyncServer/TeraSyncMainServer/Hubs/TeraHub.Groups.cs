...
public partial class TeraHub
{
    ...
    {
        _logger.LogCallInfo(TeraHubLogger.Args(dto, reason));
    ...
    public async Task<GroupJoinDto> GroupCreate()
    {
        ...
        _logger.LogCallInfo(TeraHubLogger.Args(gid));
    ...
    {
        _logger.LogCallInfo(TeraHubLogger.Args(dto, amount));
    ...
    public async Task<List<BannedGroupUserDto>> GroupGetBannedUsers(GroupDto dto)
    {
        ...
        _logger.LogCallInfo(TeraHubLogger.Args(dto, bannedGroupUsers.Count));
    ...
    public async Task<bool> GroupJoinFinalize(GroupJoinDto dto)
    {
        ...
        {
            _logger.LogCallInfo(TeraHubLogger.Args(aliasOrGid, "TempInvite", oneTimeInvite.Invite));
        ...
        _logger.LogCallInfo(TeraHubLogger.Args(aliasOrGid, "Success"));
    ...
    {
        _logger.LogCallInfo(TeraHubLogger.Args(dto, days, execute));
