...
public class TeraCensus : IHostedService
{
    ...
    private readonly ILogger<TeraCensus> _logger;
    ...
    public TeraCensus(ILogger<TeraCensus> logger)
    {
        _logger = logger;
    }
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _gauge = Metrics.CreateGauge("tera_census", "tera informational census data", new[] { "dc", "world", "gender", "race", "subrace" });
    }
