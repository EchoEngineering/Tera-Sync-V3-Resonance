...
public class ClientPairPermissionsCleanupService(ILogger<ClientPairPermissionsCleanupService> _logger, IDbContextFactory<TeraDbContext> _dbContextFactory,
    ...
    : BackgroundService
{
    ...
    private async Task<List<UserPermissionSet>> UserPermissionCleanup(int userNr, int totalUsers, string uid, TeraDbContext dbContext, List<string> pairs)
    {
    ...
    private async Task<List<string>> GetAllPairsForUser(string uid, TeraDbContext dbContext, CancellationToken ct)
    {
