...
namespace TeraSyncV2Server.Controllers;
...
public class ClientMessageController : Controller
{
    ...
    private IHubContext<TeraHub, ITeraHub> _hubContext;

    public ClientMessageController(ILogger<ClientMessageController> logger, IHubContext<TeraHub, ITeraHub> hubContext)
    {
        _logger = logger;
