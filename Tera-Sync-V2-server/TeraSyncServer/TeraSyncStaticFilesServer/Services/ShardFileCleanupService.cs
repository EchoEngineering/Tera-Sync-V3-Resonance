...
public class ShardFileCleanupService : IHostedService
{
    ...
    public ShardFileCleanupService(TeraMetrics metrics, ILogger<MainFileCleanupService> logger, IConfigurationService<StaticFilesServerConfiguration> configuration)
    {
        _metrics = metrics;
        _logger = logger;
