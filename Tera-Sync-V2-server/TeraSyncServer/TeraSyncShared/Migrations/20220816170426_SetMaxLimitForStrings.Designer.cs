...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeraSyncServer.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("TeraSyncServer.Models.FileCache", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("TeraSyncServer.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.User", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncServer.Models.Auth", b =>
                {
                    b.HasOne("TeraSyncServer.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncServer.Models.ClientPair", b =>
                {
                    b.HasOne("TeraSyncServer.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncServer.Models.FileCache", b =>
                {
                    b.HasOne("TeraSyncServer.Models.User", "Uploader")
                        .WithMany()
