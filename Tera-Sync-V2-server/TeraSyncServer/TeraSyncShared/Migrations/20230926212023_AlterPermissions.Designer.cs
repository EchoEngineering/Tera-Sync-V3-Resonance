...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserPermissionQuery", b =>
                {
                    b.Property<string>("Alias")
                        .HasColumnType("text")
                        .HasColumnName("alias");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserProfileDataReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserProfileDataReport", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "ReportedUser")
                        .WithMany()
                        .HasForeignKey("ReportedUserUID")
                        .HasConstraintName("fk_user_profile_data_reports_users_reported_user_uid");

                    b.HasOne("TeraSyncV2Shared.Models.User", "ReportingUser")
                        .WithMany()
