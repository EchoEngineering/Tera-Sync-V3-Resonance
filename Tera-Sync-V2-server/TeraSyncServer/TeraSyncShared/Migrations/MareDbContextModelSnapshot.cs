...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.Auth", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.Banned", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.BannedRegistrations", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaData", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataAllowance", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataFileSwap", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataOriginalFile", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataPose", b =>
                {
                    b.Property<string>("ParentId")
                        .HasColumnType("text")
                        .HasColumnName("parent_id");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.ClientPair", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.FileCache", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.ForbiddenUploadEntry", b =>
                {
                    b.Property<string>("Hash")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.Group", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupBan", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupPair", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupPairPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupTempInvite", b =>
                {
                    b.Property<string>("GroupGID")
                        .HasColumnType("character varying(20)")
                        .HasColumnName("group_gid");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.LodeStoneAuth", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.User", b =>
                {
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserDefaultPreferredPermission", b =>
                {
                    b.Property<string>("UserUID")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserPermissionSet", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.UserProfileData", b =>
                {
                    b.Property<string>("UserUID")
                        .HasColumnType("character varying(10)")
                        .HasColumnName("user_uid");
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.Auth", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "PrimaryUser")
                        .WithMany()
                        .HasForeignKey("PrimaryUserUID")
                        .HasConstraintName("fk_auth_users_primary_user_uid");

                    b.HasOne("TeraSyncV2Shared.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaData", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.CharaDataFile", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.FileCache", "FileCache")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.ClientPair", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "OtherUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.Group", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupBan", b =>
                {
                    b.HasOne("TeraSyncV2Shared.Models.User", "BannedBy")
                        .WithMany()
                        .HasForeignKey("BannedByUID")
                        .HasConstraintName("fk_group_bans_users_banned_by_uid");

                    b.HasOne("TeraSyncV2Shared.Models.User", "BannedUser")
                        .WithMany()
                    ...
                    b.HasOne("TeraSyncV2Shared.Models.Group", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("TeraSyncV2Shared.Models.GroupPair", b =>
                {
                    ...
                    b.HasOne("TeraSyncV2Shared.Models.User", "GroupUser")
                        .WithMany()
