...
public class TeraMetrics
{
    public TeraMetrics(ILogger<TeraMetrics> logger, List<string> countersToServe, List<string> gaugesToServe)
    {
        logger.LogInformation("Initializing TeraMetrics");
