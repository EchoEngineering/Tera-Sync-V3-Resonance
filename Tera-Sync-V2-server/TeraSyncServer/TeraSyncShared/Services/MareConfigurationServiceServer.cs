...
public sealed class TeraConfigurationServiceServer<T> : IDisposable, IConfigurationService<T> where T : class, ITeraConfiguration
{
    ...
    public TeraConfigurationServiceServer(IOptionsMonitor<T> config)
    {
        _config = config;
