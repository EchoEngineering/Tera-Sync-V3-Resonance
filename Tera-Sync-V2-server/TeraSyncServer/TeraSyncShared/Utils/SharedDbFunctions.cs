...
{
    public static async Task<(bool, string)> MigrateOrDeleteGroup(TeraDbContext context, Group group, List<GroupPair> groupPairs, int maxGroupsByUser)
    {
    ...
    public static async Task PurgeUser(ILogger _logger, User user, TeraDbContext dbContext, int maxGroupsByUser)
    {
    ...
    private static async Task<bool> TryMigrateGroup(TeraDbContext context, Group group, string potentialNewOwnerUid, int maxGroupsByUser)
    {
