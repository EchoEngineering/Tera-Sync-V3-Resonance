...
{
    private readonly IOptionsMonitor<TeraSyncConfigurationBase> _configuration;
    ...
    public ServerTokenGenerator(IOptionsMonitor<TeraSyncConfigurationBase> configuration, ILogger<ServerTokenGenerator> logger)
    {
    ...
    private string GenerateToken()
    {
        ...
        var token = new SecurityTokenDescriptor()
        {
            ...
            {
                new Claim(TeraClaimTypes.Uid, _configuration.CurrentValue.ShardName),
                new Claim(TeraClaimTypes.Internal, "true"),
                new Claim(TeraClaimTypes.Expires, DateTime.Now.AddYears(1).Ticks.ToString(CultureInfo.InvariantCulture))
            }),
