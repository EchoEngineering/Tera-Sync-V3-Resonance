...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        using (var scope = host.Services.CreateScope())
        {
            ...
            logger.LogInformation("Loaded TeraSyncV2 Services Configuration (IsMain: {isMain})", options.IsMain);
            logger.LogInformation(options.ToString());
            logger.LogInformation("Loaded TeraSyncV2 Server Configuration (IsMain: {isMain})", optionsServer.IsMain);
