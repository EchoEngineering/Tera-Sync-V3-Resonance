...
public class EditProfileUi : WindowMediatorSubscriberBase
{
    ...
    public EditProfileUi(ILogger<EditProfileUi> logger, TeraMediator mediator,
        ApiController apiController, UiSharedService uiSharedService, FileDialogManager fileDialogManager,
        TeraProfileManager teraProfileManager, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Tera Sync V2 Edit Profile###TeraSyncEditProfileUI", performanceCollectorService)
    {
        IsOpen = false;
    ...
    protected override void DrawInternal()
    {
        ...
        var profile = _teraProfileManager.GetTeraProfile(new UserData(_apiController.UID));
        ...
        ImGui.TextWrapped($"- All users that are paired and unpaused with you will be able to see your profile picture and description.{Environment.NewLine}" +
            ...
            $"- In case of valid reports from other users this can lead to disabling your profile forever or terminating your Tera Sync V2 account indefinitely.{Environment.NewLine}" +
