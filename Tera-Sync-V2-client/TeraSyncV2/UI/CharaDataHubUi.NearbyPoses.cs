...
internal partial class CharaDataHubUi
{
    private void DrawNearbyPoses()
    {
        ...
        UiSharedService.DrawTree("Settings & Filters", () =>
        {
            ...
            _uiSharedService.DrawHelpText("When enabled, Tera Sync V2 will draw floating wisps where other's poses are in the world.");
            ...
            _uiSharedService.DrawHelpText("This will allow Tera Sync V2 to continue the calculation of position of wisps etc. active outside of the 'Poses Nearby' tab." + UiSharedService.TooltipSeparator
