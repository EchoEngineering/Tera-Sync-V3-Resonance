...
public class DownloadUi : WindowMediatorSubscriberBase
{
    ...
    public DownloadUi(ILogger<DownloadUi> logger, DalamudUtilService dalamudUtilService, TeraSyncConfigService configService,
        FileUploadManager fileTransferManager, TeraMediator mediator, UiSharedService uiShared, PerformanceCollectorService performanceCollectorService)
        : base(logger, mediator, "Tera Sync V2 Downloads", performanceCollectorService)
    {
