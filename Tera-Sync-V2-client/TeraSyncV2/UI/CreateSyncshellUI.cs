...
public class CreateSyncshellUI : WindowMediatorSubscriberBase
{
    ...
    public CreateSyncshellUI(ILogger<CreateSyncshellUI> logger, TeraMediator teraMediator, ApiController apiController, UiSharedService uiSharedService,
        PerformanceCollectorService performanceCollectorService)
        : base(logger, teraMediator, "Create new Syncshell###TeraSyncCreateSyncshell", performanceCollectorService)
    {
    ...
    protected override void DrawInternal()
    {
        ...
        if (_lastCreatedGroup == null)
        {
            ...
            UiSharedService.TextWrapped("(Those preferred permissions can be changed anytime after Syncshell creation, your defaults can be changed anytime in the Tera Sync V2 Settings)");
        }
        else
        {
