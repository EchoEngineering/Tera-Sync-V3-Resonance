...
public class StandaloneProfileUi : WindowMediatorSubscriberBase
{
    ...
    public StandaloneProfileUi(ILogger<StandaloneProfileUi> logger, TeraMediator mediator, UiSharedService uiBuilder,
        ServerConfigurationManager serverManager, TeraProfileManager teraProfileManager, PairManager pairManager, Pair pair,
        PerformanceCollectorService performanceCollector)
        : base(logger, mediator, "Tera Sync V2 Profile of " + pair.UserData.AliasOrUID + "##TeraSyncV2StandaloneProfileUI" + pair.UserData.AliasOrUID, performanceCollector)
    {
    ...
    protected override void DrawInternal()
    {
        try
        {
            ...
            var teraProfile = _teraProfileManager.GetTeraProfile(Pair.UserData);
            ...
            ImGui.SameLine();
            var descriptionTextSize = ImGui.CalcTextSize(teraProfile.Description, wrapWidth: 256f);
            ...
            if (ImGui.BeginChildFrame(1000, childFrame))
            {
                ...
                ImGui.TextWrapped(teraProfile.Description);
            }
            ImGui.EndChildFrame();
