...
namespace TeraSyncV2.Services.Events;
...
public class EventAggregator : MediatorSubscriberBase, IHostedService
{
    ...
    public EventAggregator(string configDirectory, ILogger<EventAggregator> logger, TeraMediator teraMediator) : base(logger, teraMediator)
    {
