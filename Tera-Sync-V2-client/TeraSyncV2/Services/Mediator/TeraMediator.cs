...
public sealed class TeraMediator : IHostedService
{
    ...
    public TeraMediator(ILogger<TeraMediator> logger, PerformanceCollectorService performanceCollector, TeraSyncConfigService teraConfigService)
    {
        _logger = logger;
    ...
    {
        _logger.LogInformation("Starting TeraMediator");
        ...
        _logger.LogInformation("Started TeraMediator");
