...
namespace TeraSyncV2.PlayerData.Services;
...
public sealed class CacheCreationService : DisposableMediatorSubscriberBase
{
    ...
    public CacheCreationService(ILogger<CacheCreationService> logger, TeraMediator mediator, GameObjectHandlerFactory gameObjectHandlerFactory,
