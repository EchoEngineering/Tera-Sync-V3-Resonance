...
using Enum_ObjectKind = TeraSyncV2.API.Data.Enum.ObjectKind;
using ObjectKind = TeraSyncV2.API.Data.Enum.ObjectKind;

namespace TeraSyncV2.PlayerData.Handlers;
...
public sealed class GameObjectHandler : DisposableMediatorSubscriberBase, IHighPriorityMediatorSubscriber
{
    ...
    public GameObjectHandler(ILogger<GameObjectHandler> logger, PerformanceCollectorService performanceCollector,
        TeraMediator mediator, DalamudUtilService dalamudUtil, Enum_ObjectKind objectKind, Func<IntPtr> getAddress, bool ownedObject = true) : base(logger, mediator)
    {
