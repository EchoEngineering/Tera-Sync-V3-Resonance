...
namespace TeraSyncV2.Utils;

[InterpolatedStringHandler]
public readonly ref struct TeraInterpolatedStringHandler
{
    readonly StringBuilder _logMessageStringbuilder;

    public TeraInterpolatedStringHandler(int literalLength, int formattedCount)
    {
