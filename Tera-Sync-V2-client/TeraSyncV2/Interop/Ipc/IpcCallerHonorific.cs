...
public sealed class IpcCallerHonorific : IIpcCaller
{
    ...
    {
        _teraMediator.Publish(new HonorificMessage(string.Empty));
    }
    ...
    private void OnHonorificLocalCharacterTitleChanged(string titleJson)
    {
        ...
        _teraMediator.Publish(new HonorificMessage(titleData));
    }

    private void OnHonorificReady()
    {
        CheckAPI();
        _teraMediator.Publish(new HonorificReadyMessage());
    }
}
