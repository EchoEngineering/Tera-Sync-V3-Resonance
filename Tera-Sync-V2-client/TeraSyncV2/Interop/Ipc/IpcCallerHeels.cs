...
public sealed class IpcCallerHeels : IIpcCaller
{
    ...
    public IpcCallerHeels(ILogger<IpcCallerHeels> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, TeraMediator teraMediator)
    {
        _logger = logger;
    ...
    {
        _teraMediator.Publish(new HeelsOffsetMessage());
    }
