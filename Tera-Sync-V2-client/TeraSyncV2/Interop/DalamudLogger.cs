...
internal sealed class DalamudLogger : ILogger
{
    ...
    public DalamudLogger(string name, TeraSyncConfigService teraConfigService, IPluginLog pluginLog, bool hasModifiedGameFiles)
    {
        _name = name;
    ...
    {
        return (int)_teraSyncConfigService.Current.LogLevel <= (int)logLevel;
    }
